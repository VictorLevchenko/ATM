...
public class AtmController {
	...
	public Map<String, String> withdrawAction(@RequestBody Map<String,String> requestParam) 
		...
		boolean isHaveAmount = 
				accountService.checkIfUserHaveAmountOnAccount(user, amount);
		...
		boolean isSusscessWithdrawAmountFromAccount = 
				accountService.withdrawAmountFromUserAccount(user, amount);
		logger.info(">> isSusscessWithdrawAmountFromAccount = " +
				isSusscessWithdrawAmountFromAccount);
